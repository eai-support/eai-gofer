...
```
Task: subagent_type="comms-writer", model_tier="simple"
...
```
Task: subagent_type="business-metrics-analyzer", model_tier="simple"
...
```
Task: subagent_type="assumption-tracker", model_tier="simple"
...
```
Task: subagent_type="scope-creep-detector", model_tier="simple"
