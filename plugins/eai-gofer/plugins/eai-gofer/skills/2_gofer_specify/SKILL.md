...
5. If the user says yes, run the Gofer workspace bootstrap helper and then
   resume this command from the top.
6. If the user says no, stop and explain that Gofer stage/helper work depends on
