...
update `.specify/specs/{feature}/delivery-lineage.json` with work-order nodes
linked to the requirements, decisions, and customer files they will change.
...
8. Output: `tasks.md`, `traceability.md`, `issues.md`,
   ...
   `stakeholder-review-index.md`; for app delivery, tasks must also preserve and
   update `build-map.md`
