...
Use this as the single user-facing Gofer command. Users should run `/eai-gofer`, `$eai-gofer`, or `#eai-gofer` depending on the host. Do not ask users to run numbered stage commands unless they explicitly request low-level internals.
