...
| Time              | Change Trigger     | Command             | URL             | Browser Target        | Screenshot                   | Package Lane | Coupling Status     | Storybook Story IDs | Theme Override Points | Self-Review     | Stakeholder Feedback | Changes Accepted | Open Issues |
| ----------------- | ------------------ | ------------------- | --------------- | --------------------- | ---------------------------- | ------------ | ------------------- | ------------------- | --------------------- | --------------- | -------------------- | ---------------- | ----------- |
| {{ISO-timestamp}} | {{change-summary}} | {{preview-command}} | {{preview-url}} | Integrated / External | {{screenshot-or-playwright}} | {{lane}}     | {{coupling-status}} | {{story-ids}}       | {{theme-overrides}}   | {{self-review}} | {{feedback}}         | {{accepted}}     | {{open}}    |
