...
- Stage work uses the plain repo slash commands, for example `/0_gofer_start`,
  `/1_gofer_research`, and `/6_gofer_validate`.
...
before `/0_gofer_start`. It is intentionally allowed before `.specify/` exists.
