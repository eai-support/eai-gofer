...
before bootstrapping. Keep the user-facing surface simple: users see only eai;
numbered stages and helpers are internal contracts.

Primary outputs:

- A clear route into the public `eai` entrypoint, first-run setup, or standalone
  research.
