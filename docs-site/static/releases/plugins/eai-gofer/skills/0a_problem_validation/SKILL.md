...
Mark ALL assumptions as `UNVALIDATED` at this stage. Populate the **Drift
Controls** table with an owner, expiry/revalidation date, trigger, and reopen
stage for every assumption that could invalidate the plan later.
